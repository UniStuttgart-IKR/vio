...
add wave -noupdate -group IO -radix hexadecimal /riscvio_soc_tb/soc_i/riscvio_i/io_mode
add wave -noupdate -group IO -radix hexadecimal /riscvio_soc_tb/soc_i/riscvio_i/io_dev
add wave -noupdate -group IO /riscvio_soc_tb/soc_i/io_ix
add wave -noupdate -group IO -radix hexadecimal /riscvio_soc_tb/soc_i/riscvio_i/io_rdata
add wave -noupdate -group IO -radix hexadecimal /riscvio_soc_tb/soc_i/riscvio_i/io_stall
add wave -noupdate -group IO -radix ascii /riscvio_soc_tb/soc_i/riscvio_i/io_wdata
add wave -noupdate -group IO -radix ascii /riscvio_soc_tb/soc_i/io_mux_i/uart_tx_data
add wave -noupdate -group IO /riscvio_soc_tb/soc_i/rx
add wave -noupdate -group IO /riscvio_soc_tb/soc_i/tx
...
WaveRestoreCursors {{Cursor 1} {933 ns} 0} {{Cursor 2} {1713 ns} 1}
...
update
WaveRestoreZoom {873 ns} {1023 ns}
