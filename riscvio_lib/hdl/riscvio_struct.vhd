...
ARCHITECTURE struct OF riscvio IS
   ...
   SIGNAL exc_dc                        : exc_reason_T;
   SIGNAL exc_dc_u                      : exc_reason_T;
   SIGNAL exc_ex                        : exc_reason_T;
   SIGNAL exc_ex_u                      : exc_reason_T;
   SIGNAL exc_me                        : exc_reason_T;
   SIGNAL exc_me_u                      : exc_reason_T;
   SIGNAL exc_wb                        : exc_reason_T;
