...
ARCHITECTURE struct OF riscvio IS
   ...
   SIGNAL a                : word_T;
   SIGNAL alu_a_in_sel     : alu_in_sel_T;
   SIGNAL alu_b_in_sel     : alu_in_sel_T;
   ...
   SIGNAL static_branch_pc : word_T;
...
BEGIN
   ...
   next_pc_mux_i : next_pc_mux
      PORT MAP (
         ...
         static_branch_pc  => static_branch_pc,
         dynamic_branch_pc => dbta,
         dbta_valid        => dbta_valid,
         sbta_valid        => sbta_valid,
