...
add wave -noupdate -expand -group DC -color Cyan -itemcolor {Light Blue} -radix hexadecimal -childformat {{/riscvio_tb/riscvio_i/csr_unit_i/csrs(alc_lim) -radix hexadecimal} {/riscvio_tb/riscvio_i/csr_unit_i/csrs(alc_addr) -radix hexadecimal} {/riscvio_tb/riscvio_i/csr_unit_i/csrs(frame_lim) -radix hexadecimal} {/riscvio_tb/riscvio_i/csr_unit_i/csrs(core) -radix hexadecimal} {/riscvio_tb/riscvio_i/csr_unit_i/csrs(root) -radix hexadecimal}} -subitemconfig {/riscvio_tb/riscvio_i/csr_unit_i/csrs(alc_lim) {-color Cyan -height 24 -itemcolor {Light Blue} -radix hexadecimal} /riscvio_tb/riscvio_i/csr_unit_i/csrs(alc_addr) {-color Cyan -height 24 -itemcolor {Light Blue} -radix hexadecimal} /riscvio_tb/riscvio_i/csr_unit_i/csrs(frame_lim) {-color Cyan -height 24 -itemcolor {Light Blue} -radix hexadecimal} /riscvio_tb/riscvio_i/csr_unit_i/csrs(core) {-color Cyan -height 24 -itemcolor {Light Blue} -radix hexadecimal} /riscvio_tb/riscvio_i/csr_unit_i/csrs(root) {-color Cyan -height 24 -itemcolor {Light Blue} -radix hexadecimal}} /riscvio_tb/riscvio_i/csr_unit_i/csrs
